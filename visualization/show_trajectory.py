"""
This script visualizes the path and trajectory found by the A* algorithm in 3D space. The obstacles, lattice points, edges, path, and trajectory are plotted in 3D space. The data is read from CSV files and filtered based on the bounding box of the path. The obstacles are shown as red boxes, lattice points as blue points, edges as green lines, the path as a red line, and the trajectory as
a magenta line.
"""
...
trajectory_df = pd.read_csv('../data/trajectory_output.csv')
